...
p = Point(within_bounds["features"][0]["geometry"]["coordinates"])
b = Polygon(within_bounds["features"][1]["geometry"]["coordinates"][0])

print(b.contains(p.buffer(-1e-14)))  # True
print(b.touches(p))  # True

p = Point(outside_bounds["features"][0]["geometry"]["coordinates"])
b = Polygon(outside_bounds["features"][1]["geometry"]["coordinates"][0])

print(b.contains(p))  # False
